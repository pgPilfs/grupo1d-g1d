...
{
    public class GestorLoginRespuesta
    {

        public LoginRespuesta Respuesta(string user)
        {
            LoginRespuesta loginRespuesta = null; // creo el objeto del tipo LoginRequest que por el momento puede ser vacio
                ...
                SqlConnection conn = new SqlConnection(connection))
            {
                ...
                comm.CommandText = "respuesta"; // el comando se va a llamar login 
